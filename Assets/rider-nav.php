  ...
  <a class="navbar-brand" href=""><h2><b>FOOD  <span style="color: orange;">FUD  </b></span></h2></a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="Rider.php">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="RiderPending.php">MyOrder
          <?php 
            require_once './db.php';
            $sql = "SELECT * FROM pending where RiderID = '".$_SESSION['UserID']."'";
            $query = $db->query($sql);
